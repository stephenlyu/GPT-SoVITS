...
def dump_args(ref_wav_path, prompt_text, prompt_language, text, text_language, how_to_cut=i18n("不切"), top_k=20, top_p=0.6, temperature=0.6, ref_free = False):
    args = {
    ...
    import json
    json_file = 'TEMP/infer-args.json'
    with open(json_file, 'w') as f:
        json.dump(args, f)
    print('gpt_path=%s sovits_path=%s python GPT_SoVITS/inference_console.py %s' % (gpt_path, sovits_path, json_file))

def get_tts_wav(ref_wav_path, prompt_text, prompt_language, text, text_language, how_to_cut=i18n("不切"), top_k=20, top_p=0.6, temperature=0.6, ref_free = False):
    dump_args(ref_wav_path, prompt_text, prompt_language, text, text_language, 
